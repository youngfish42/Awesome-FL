...
|Title                                                        | Affiliation                                   | Venue                                                 | Year | Materials|
| ------------------------------------------------------------ | --------------------------------------------- | ----------------------------------------------------- | ---- | ------------------------------------------------------------ |
| FedGCN: Convergence and Communication Tradeoffs in Federated Training of Graph Convolutional Networks | CMU | NeurIPS :mortar_board: | 2023 | [[PDF](https://arxiv.org/abs/2201.12433)] [[CODE](https://github.com/yh-yao/FedGCN)] |
| Wyze Rule: Federated Rule Dataset for Rule Recommendation Benchmarking | CMU | NeurIPS Dataset Track :mortar_board: | 2023 | [[PDF](https://openreview.net/forum?id=qynH28Y4xE)] [[DATASET](https://huggingface.co/datasets/wyzelabs/RuleRecommendation)] [[CODE](https://github.com/yh-yao/FedRule)] |
...
| FedRule: Federated Rule Recommendation System with Graph Neural Networks | CMU | IoTDI | 2023 | [[PUB](https://dl.acm.org/doi/10.1145/3576842.3582328)] [[PDF](https://arxiv.org/abs/2211.06812)] [[CODE](https://github.com/yh-yao/FedRule)] |
